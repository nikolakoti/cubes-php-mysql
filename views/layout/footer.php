    ...
    <div class="container">
        <div class="clients block">
            ...
            <ul class="thumbnails list-unstyled row">
                <?php foreach (brandsFetchRandom() as $brandRandom) { ?>
                    <li class="col-sm-2">
                        <a href="/brand.php?id=<?php echo htmlspecialchars($brandRandom['id']); ?>" class="well well-lg text-uppercase text-justify">
                            <?php echo htmlspecialchars($brandRandom['title']); ?>
                        </a>
                    </li>
                <?php } ?>
            </ul>
